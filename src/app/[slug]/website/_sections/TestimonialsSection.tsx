...
export function TestimonialsSection({ testimonials, accentColor, headingFont }: SectionProps) {
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-semibold text-[#1a1a1a] leading-tight" style={{ fontFamily: headingFont }}>
                        What brands say <span style={{ color: accentColor }}>about working with me.</span>
                    </h2>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.slice(0, 6).map((t) => (
                        <div key={t.id} className="bg-white rounded-2xl p-8 shadow-sm flex flex-col">
                            ...
                            <p className="text-[#1a1a1a]/80 leading-relaxed text-base flex-1 mb-6">
                                {t.quote}
                            </p>
                            ...
                            <div className="flex items-center gap-3 pt-4 border-t border-[#1a1a1a]/5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-[#1a1a1a]/50">
                                        {t.authorTitle ? `${t.authorTitle}, ` : ""}{t.company}
                                    </p>
                                </div>
                            </div>
                        </div>
